...
import impression.FenetreImpressionResultatUeSansNote;
...
public class FenetreResultat extends JFrame{
	...
	/*panel de la deliberation personnel */
	 ...
	 String titrePanDelib[]= {"Relevé de Note de l'Université de Fianarantsoa à la Faculté des Sciences"};
	 JPanel panDelib[];
	 JPanel panInfDelib[];
	 JPanel panPanDelib[];
	...
	public  FenetreResultat(JFrame parent, String title, boolean modal,String mention
		...
		//Othis.setModalityType(ModalityType.APPLICATION_MODAL);
		...
		printUeSansNote=new JButton[nbrSems];
		...
		for(int i=0;i<nbrSems;i++) {
			...
			moyenT[i]=new JLabel();
			img[i]=new JLabel();
			sems[i]=new JLabel("Semestre "+(i+debutSems+1));
			...
			printUeSansNote[i]=new JButton (LoadImage.transformeb(100, 25, "/imprim.jpg"));
			...
			snValid[i].setToolTipText("Résultat Session normal définitive");
			srValid[i].setToolTipText("Résultat Session Rattrapage définitive");
			srComp[i].setToolTipText("Résultat Session Rattrapage par Compensation");
			
			valUeEc[i].setToolTipText("Liste des étudiant(s) ayant validé(s) à la fois l'U.E et l'E.C ");
			NovalUeEc[i].setToolTipText("Liste des étudiants qui doivent faire la session rattrapage");
			
			valide[i].setToolTipText("Reléve des Notes");
			...
			semsValidation[i]=new JCheckBox("Sélectionner tout");
			...
			panTableListOK[i].setPreferredSize(new Dimension(400,600));
			panTableListNoOK[i].setPreferredSize(new Dimension(400,600));
			...
			vide[i].setPreferredSize(new Dimension(280,20));
			...
			printUeSansNote[i].setPreferredSize(new Dimension(100,25));
			...
			panTableListOK[i].add(vide[i]);
			panTableListOK[i].add(printUeSansNote[i]);
			printUe[i].setVisible(false);
			printUeSansNote[i].setVisible(false);
			...
			printUeSansNote[i].addActionListener(new ImprimerResultatSansNote(i));
		...
		scrol1=new JScrollPane(layeredPane);
		this.setContentPane(scrol1);
	...
	public  class ImprimerResultatSansNote implements ActionListener{
		int i;
		ImprimerResultatSansNote(int i){
			this.i=i;
		}
		public void actionPerformed(ActionEvent arg0) {
			if(type=="final")
				type="Rattrapage";
			new FenetreImpressionResultatUeSansNote(modelList1[i],mention,parcour,type,semestre[i],(i+1+debutSems),
					Methode.finit(Methode.getNom(tableUe[i]),i)).setVisible(true);
		}
	}
		...
		public void mouseClicked(MouseEvent e) {
		 if(tableUe[i].getRowCount()>0 && tableUe[i].getSelectedRow()!=-1) {
			...
			if(e.getClickCount()==2) {
				...
				printUeSansNote[i].setVisible(true);
				panValidNorm[i].setVisible(false);
				panValidRat[i].setVisible(false);
				panValidComp[i].setVisible(false);
				panParUe[i].setVisible(false);
				...
				result1[i].setText(modelList1[i].getRowCount()+" Etudiant(s) ont validé(s) l'U.E: "+Methode.finit(Methode.getNom(tableUe[i]),i));
				result2[i].setText(modelList2[i].getRowCount()+" Etudiant(s) n'ont pas validé(s) l'U.E: "+Methode.finit(Methode.getNom(tableUe[i]),i));
			}
		 }
		}
		...
		public void mouseClicked(MouseEvent e) {
		 if(tableEc[i].getRowCount()>0 && tableEc[i].getSelectedRow()!=-1) {
			...
			if(e.getClickCount()==2) {
				...
				result1[i].setText(modelList1[i].getRowCount()+" Etudiant(s) ont validé(s) l'E.C: "+Methode.finit(Methode.getNom(tableEc[i]),i));
				result2[i].setText(modelList2[i].getRowCount()+" Etudiant(s) n'ont pas validé(s) l'E.C: "+Methode.finit(Methode.getNom(tableEc[i]),i));
			}
		 }
		}
		public void mouseEntered(MouseEvent arg0) {}
	...
	public   class valideUeEc implements ActionListener{
		...
		public void actionPerformed(ActionEvent e) {
			...
			result1[i].setText("Moyenne de l'U.E: "+Methode.finit(typeUe[i].getText(),i)+" de "+modelList1[i].getRowCount()+" étudiant(s) ");
	...
	public   class getCredInf implements ActionListener{
		...
		public void actionPerformed(ActionEvent e) {
			...
			resultCrdt[i].setText(modelCred[i].getRowCount()+" étudiant(s) ont obtenu(s) le crédit inférieur à "+credTxt[i].getText());
			}
		  }
		}
	public   class getCredEgal implements ActionListener{
		...
		public void actionPerformed(ActionEvent e) {
			...
			DataBase.resultCreditegal(mention, semestre[i], (i+debutSems+1), k, modelCred[i], type, 
										Integer.parseInt(credTxt[i].getText()));
			resultCrdt[i].setText(modelCred[i].getRowCount()+" étudiant(s) ont obtenu(s) le crédit égal à "+credTxt[i].getText());
			}
		  }	
		}
	...
	public   class getCredSup implements ActionListener{
		...
		public void actionPerformed(ActionEvent e) {
			...
			DataBase.resultCreditsup(mention, semestre[i], (i+debutSems+1), k, modelCred[i], type, 
												Integer.parseInt(credTxt[i].getText()));
			resultCrdt[i].setText(modelCred[i].getRowCount()+" étudiant(s) ont obtenu(s) le crédit supérieur à "+credTxt[i].getText());
			}
		   }
		}
	...
	public   class getMoyenInf implements ActionListener{
		...
		public void actionPerformed(ActionEvent e) {
			...
			resultMoyen[i].setText(modelMoyen[i].getRowCount()+" étudiant(s) ont obtenu(s) la moyenne inférieure à "+moyenTxt[i].getText());
			}
		  }
		}
	public   class getMoyenEgal implements ActionListener{
		...
		public void actionPerformed(ActionEvent e) {
			...
			DataBase.resultMoyenegal(mention, semestre[i], (i+debutSems+1), k, modelMoyen[i], type, 
										Double.parseDouble(moyenTxt[i].getText()));
			resultMoyen[i].setText(modelMoyen[i].getRowCount()+" étudiant(s) ont obtenu(s) la moyenne égale à "+moyenTxt[i].getText());
			}
		  }
		}
	...
	public   class getMoyenSup implements ActionListener{
		...
		public void actionPerformed(ActionEvent e) {
			...
			DataBase.resultMoyensup(mention, semestre[i], (i+debutSems+1), k, modelMoyen[i], type, 
												Double.parseDouble(moyenTxt[i].getText()));
			resultMoyen[i].setText(modelMoyen[i].getRowCount()+" étudiant(s) ont obtenu(s) la moyenne supérieure à "+moyenTxt[i].getText());
			}
		}
		}
	...
	public   class validFinal implements ActionListener{
		...
		public void actionPerformed(ActionEvent e) {
			...
			JOptionPane.showMessageDialog(pan,"Opération terminée","",JOptionPane.INFORMATION_MESSAGE);
			}
	...
	public   class ListesNorm implements ActionListener{
		...
		ListesNorm(int i){
			...
			result3[i].setText(modelValidNorm[i].getRowCount()+" étudiant(s) ont validé(s) définitivement la session normale" );
	...
	public   class ListesRat implements ActionListener{
		...
		ListesRat(int i){
			...
			panParUe[i].setVisible(false);
			DataBase.typeResult(mention,semestre[i],(i+debutSems+1), k,modelValidNorm[i],modelValidRat[i],modelValidComp[i]);
			result4[i].setText(modelValidRat[i].getRowCount()+"  étudiant(s) ont validé(s) définitivement la session rattrapage" );
		}
	}
	...
	public   class ListesComp implements ActionListener{
		...
		ListesComp(int i){
			...
			panParUe[i].setVisible(false);
			DataBase.typeResult(mention,semestre[i],(i+debutSems+1), k,modelValidNorm[i],modelValidRat[i],modelValidComp[i]);
			result5[i].setText(modelValidComp[i].getRowCount()+" étudiant(s) ont validé(s) par Compensation la session" );
		}
	}
	...
	public   class Licence implements ActionListener{
		...
		Licence(int i){
			...
			resultLic.setText(modelLicence.getRowCount()+" étudiant(s) ont validé(s) le semestre S6" );
			resultListLic.setText(modelListLicence.getRowCount()+" étudiant(s) ont obtenu(s) le diplôme de LICENCE" );
		}
	}
	...
	public   class Master implements ActionListener{
		...
		Master(int i){
			...
			resultMas.setText(modelMaster.getRowCount()+" étudiant(s) ont validé(s) le semestre S10" );
			resultListMas.setText(modelListMaster.getRowCount()+" étudiant(s) ont obtenu(s) le diplôme MASTER 2" );
		}
	}
	...
	public   class ActLicence implements ActionListener{
		public void actionPerformed(ActionEvent e) {
			DataBase.act_diplome(mention,modelListLicence,"S5","S6");
			resultListLic.setText(modelListLicence.getRowCount()+" étudiant(s) ont obtenu(s) le diplôme LICENCE" );
		}
	}
	...
	public   class ActMaster implements ActionListener{
		public void actionPerformed(ActionEvent e) {
			...
			resultListMas.setText(modelListMaster.getRowCount()+" étudiant(s) ont  obtenu(s) le diplôme MASTER" );
		}
	}
	
	public   boolean testDouble(String num) {
		boolean rep=false;
		if((num.length()!=0)&&(num!="Abs")) {
			try {
			Double.parseDouble(num);
			rep=true;
			}catch(Exception e) {
				JOptionPane.showMessageDialog(pan,"Nombre invalide","",JOptionPane.INFORMATION_MESSAGE);
