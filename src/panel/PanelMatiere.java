...
public class PanelMatiere extends JPanel{
	 ...
	 JButton sauv =new JButton( LoadImage.transformeb(100, 25, "/sauvegarde.jpg"));
	...
	public PanelMatiere(String titre,String mention,JComboBox semestre,int t,String filier) {
		...
		sauv.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
		...
		sauv.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try {
					...
					if(t==0)
						Methode.sauvegarde_matiere(mention,t,t,semestre.getItemCount() );
					else
						Methode.sauvegarde_matiere(mention,t,1,semestre.getItemCount() );	
