...
import impression.FenetreImpressionListeParGroupe;
...
public class FenetreListeParGroupe extends JFrame{
	...
	public  FenetreListeParGroupe(JFrame parent, String title, boolean modal,String mention
		...
		//	modelPanDelib[i].addColumn(titrePanDelib[0]);
			...
			panPrincipale[i].setBackground(Color.LIGHT_GRAY);
			panMatiere[i].setBackground(Color.LIGHT_GRAY);
			panNote[i].setBackground(Color.LIGHT_GRAY);
			...
			panMatiere[i].add(gp[i]);
			panMatiere[i].add(groupe[i]);
			...
			groupe[i].setPreferredSize(new Dimension(30,20));
			num1[i].setPreferredSize(new Dimension(30,20));
			num2[i].setPreferredSize(new Dimension(30,20));
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		modelPanDelib[i]=DataBase.liste(mention, semestre[i], i+debutSems+1, k, modelPanDelib[i],panPanDelib[i],x,y);
		valUe[i].setEnabled(true);
	}
	}
	...
	public  class Imprimer1 implements ActionListener{
		...
		public void actionPerformed(ActionEvent arg0) {
			...
			new FenetreImpressionListeParGroupe(modelPanDelib[i],mention,parcour,type,semestre[i],(i+1+debutSems),
					groupe[i].getText(),5,x,y).setVisible(true);
			groupe[i].setText("");
			num1[i].setText("");
