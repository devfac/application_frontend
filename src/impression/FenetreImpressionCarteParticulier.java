...
public class FenetreImpressionCarteParticulier extends JDialog {
      ...
      public int nbr=0;
		...
		public FenetreImpressionCarteParticulier(String mention,String clas,int k,DefaultTableModel model) {
        	  super();
  		...
  		this.addWindowListener(new WindowAdapter() {
             ...
             try {
            	...
            	rset = statement.executeQuery("SELECT * FROM table_maths INNER JOIN table_sems ON "
            			...
            			+ "WHERE (choix_2='"+clas1+"'OR choix_2='"+clas2+"')AND table_maths.num_carte='"
            			+String.valueOf(model.getValueAt(i, 0))+"' ORDER BY table_maths.num_carte");
            	...
            	while(rset.next()) {
            		feeds.add(new RecuperInfo(rset.getString(1),rset.getString(2),rset.getString(3),
            				...
            				rset.getString(17),DataBase.recuperNomSco(),rset.getString(7),rset.getString("choix_1"),rset.getString("choix_2")));
            		nbr++;
            	}
            	rset.close();
            	statement.close();
            ...
            // JTable table = new JTable(new RssFeedTableModel(feeds)); 
             ...
             gradesTable.setDefaultRenderer(RecuperInfo.class, new DeriereCarte(mention));
             }
        ...
        /* Set a custom renderer on the "Passed" column */         
           ...
           showPrintDialogBox.addActionListener(new ActionListener() {             
            public void actionPerformed(ActionEvent ae) {                 
                 ...
                 JOptionPane.showMessageDialog(FenetreImpressionCarteParticulier.this,"If the Print Dialog is not shown,"+ " the default printer is used.", 
           ...
           interactiveBox.addActionListener(new ActionListener() {             
              public void actionPerformed(ActionEvent ae) {                 
                    if (!interactiveBox.isSelected()) {                     
                        JOptionPane.showMessageDialog(FenetreImpressionCarteParticulier.this,"If non-interactive, the GUI is fully blocked"
