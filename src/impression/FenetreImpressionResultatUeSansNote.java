...
public class FenetreImpressionResultatUeSansNote extends JDialog {
      ...
      String parcour,session,sems,ue;
		...
		public FenetreImpressionResultatUeSansNote(DefaultTableModel model2,String mention,String parcour,
        ...
        /* Set a custom renderer on the "Passed" column */         
           ...
           showPrintDialogBox.addActionListener(new ActionListener() {             
            public void actionPerformed(ActionEvent ae) {                 
                 ...
                 JOptionPane.showMessageDialog(FenetreImpressionResultatUeSansNote.this,"If the Print Dialog is not shown,"+ " the default printer is used.", 
           ...
           interactiveBox.addActionListener(new ActionListener() {             
              public void actionPerformed(ActionEvent ae) {                 
                    if (!interactiveBox.isSelected()) {                     
                        JOptionPane.showMessageDialog(FenetreImpressionResultatUeSansNote.this,"If non-interactive, the GUI is fully blocked"
                    ...
                    //pan.add(note);
                	  ...
                	  if(row!=model2.getRowCount()+2) {
		                ...
		                // pan.add(note);
                		  ...
                		  pan.setBackground(Color.white);
                		  pan1 = new JPanel();
                		  pan1.setPreferredSize(new Dimension(650,100));
                		  JLabel result=new JLabel("<html> <div id='bloc_page'> <p>ARRETEE&nbsp;LA&nbsp;PRESENTE&nbsp;LISTE&nbsp;"
                		  		+ "AU&nbsp;NOMBRE&nbsp;"
                		  ...
                		  JLabel lab=new JLabel("<html> <div id='bloc_page'><p>Fianarantsoa, le</p></div></html>");
                		  result.setPreferredSize(new Dimension(650,35));
                		  lab.setPreferredSize(new Dimension(650,35));
                		  pan.add(result);
                		  //pan1.add(lab);
                		 // pan.add(pan1);
                	  }
