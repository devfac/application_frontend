        ...
        this.setModalityType(ModalityType.APPLICATION_MODAL);
  		this.addWindowListener(new WindowAdapter() {
            ...
            // JTable table = new JTable(new RssFeedTableModel(feeds)); 
             ...
             gradesTable.setRowHeight(i,31);
             gradesTable.setRowHeight(feeds.size()-1,230);
             gradesTable.setFillsViewportHeight(false);
             gradesTable.setShowGrid(false);
             gradesTable.setPreferredScrollableViewportSize(new Dimension(730,530));
                  ...
                  try {        
                	  ...
                	  PrinterJob pj=PrinterJob.getPrinterJob();
              			...
              			for(PrintService print:ps) {
              				if(print.getName().equals("Foxit Reader PDF Printer"))
              					try {
									pj.setPrintService(print);
								} catch (Exception e) {
                	  ...
                	  paper.setImageableArea(margin, 
                			  ...
                			  margin, margin);
                	  pf.setPaper(paper);
                	  pj.setPrintable(gradesTable.getPrintable(JTable.PrintMode.FIT_WIDTH, null, null), pj.validatePage(pf));
                	  pj.print();
                    /* print the table */           
                  ...
                  if(row==0) {                	 
                    ...
                    pan.add(note);
                	  ...
                	  if(row!=model2.getRowCount()+2) {
		                 ...
		                 num.setPreferredSize(new Dimension(80,25));
		                 nom.setPreferredSize(new Dimension(440,25));
		                 note.setPreferredSize(new Dimension(40,25));
		                 num.setHorizontalAlignment(JLabel.CENTER);
		                 ...
		                 note.setBorder(line);
                		  ...
                		  pan.setBackground(Color.white);
                		  JLabel result=new JLabel("<html> <div id='bloc_page'><p>ARRETEE&nbsp;LA&nbsp;PRESENTE&nbsp;"
                		  		+ "LISTE&nbsp;AU&nbsp;NOMBRE&nbsp;"
                		  ...
                		  JLabel date=new JLabel("<html> <div id='bloc_page'>"
                		  		+ "Fianarantsoa le,</div></html>");
                		  JLabel espace=new JLabel();
                		  result.setPreferredSize(new Dimension(650,90));
                		  date.setPreferredSize(new Dimension(100,40));  
                		  espace.setPreferredSize(new Dimension(300,40));             		  
                		  pan.add(result);
                		  pan.add(espace);
                		  pan.add(date);
