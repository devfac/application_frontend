            ...
            return this;         
              ...
              public Component getTableCellRendererComponent(JTable table, Object value,
                  ...
                  if(row==0) {
                	  ...
                	  switch(type) {
                	  case 0:  titre=new JLabel("<html> <div id='bloc_page'> RESULTAT&nbsp;SESSION&nbsp;NORMALE&nbsp;</div></html>");
                	  break;
                	  case 1:   titre=new JLabel("<html> <div id='bloc_page'> RESULTAT&nbsp;&nbsp;SESSION&nbsp;RATTRAPAGE&nbsp;</div></html>");
                	  break;
                	  case 2: titre=new JLabel("<html> <div id='bloc_page'> RESULTAT&nbsp;PAR&nbsp;COMPENSATION&nbsp;</div></html>");
                	  break;
                	  }
                	...
                	pan.setBackground(Color.white);
                	  ...
                	  if(row!=model2.getRowCount()+2) {
		                 ...
		                 pan.add(nom);
                		  ...
                		  switch(type) {
                		  case 0: result=new JLabel("<html> <div id='bloc_page'><p>ARRETEE&nbsp;LA&nbsp;PRESENTE&nbsp;LISTE&nbsp;AU&nbsp;NOMBRE&nbsp;"
                		  		+ "DE&nbsp;"+model2.getRowCount()+"&nbsp;ETUDIANT(S)&nbsp;</p>AYANT&nbsp;VALIDE&nbsp;" 
                		  				                	 + "LES&nbsp;TRENTE&nbsp;CREDITS&nbsp;(30&nbsp;Crédits)&nbsp;EN&nbsp;SESSION&nbsp;NORMALE"
                		  				                	 + "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Le PRESIDENT DU JURY</div></html>");
                		  break;
                		  case 1: result=new JLabel("<html> <div id='bloc_page'><p>ARRETEE&nbsp;LA&nbsp;PRESENTE&nbsp;LISTE&nbsp;AU&nbsp;NOMBRE&nbsp;" 
                		  		+"DE&nbsp;"+model2.getRowCount()+"&nbsp;ETUDIANT(S)&nbsp;</p>AYANT&nbsp;VALIDE&nbsp;LES&nbsp;TRENTE&nbsp;CREDITS&nbsp;(30&nbsp;Crédits)&nbsp;"
                		  				+ "SESSION&nbsp;DE&nbsp;RATTRAPAGE"
                		  				+ "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Le PRESIDENT DU JURY</div></html>");
                  		  break;
                		  case 2: result=new JLabel("<html> <div id='bloc_page'><p>ARRETEE&nbsp;LA&nbsp;PRESENTE&nbsp;LISTE&nbsp;AU&nbsp;NOMBRE&nbsp;" 
                  		  		+"DE&nbsp;"+model2.getRowCount()+"&nbsp;ETUDIANT(S)</p>&nbsp;AYANT&nbsp;VALIDE&nbsp;LES&nbsp;TRENTE&nbsp;CREDITS&nbsp;(30&nbsp;Crédits)&nbsp;SESSION&nbsp;DE&nbsp;"
				                	 + "RATTRAPAGE&nbsp;APRES&nbsp;COMPENSATION"
				                	 + "<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Le PRESIDENT DU JURY</div></html>");
                  		  break;
                		  }
