...
public class FenetreImpressionListeDroit extends JFrame {
      ...
      protected JTextField footerField;
		...
		public FenetreImpressionListeDroit(DefaultTableModel model,String titre) {
             ...
             super("Impression Liste de droit versé par les etudiants inscrits");
             ...
             gradesLabel = new JLabel("Liste de droit versé par les etudiants inscrits en "+titre);         
        ...
        /* Set a custom renderer on the "Passed" column */         
           ...
           headerField = new JTextField("Liste de droit versé par les etudiants inscrits en "+titre);         
