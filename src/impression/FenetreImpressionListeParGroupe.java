...
public class FenetreImpressionListeParGroupe extends JDialog {
      ...
      String parcour,session,sems,ue;
		...
		public FenetreImpressionListeParGroupe(DefaultTableModel model2,String mention,String parcour,
            ...
            // JTable table = new JTable(new RssFeedTableModel(feeds)); 
			 ...
			 for(int i=0;i<model2.getRowCount();i++) {
				 feeds.add(new RecuperInfo1(String.valueOf(model2.getValueAt(i, 0)), String.valueOf(model2.getValueAt(i, 1))
						 	, String.valueOf(model2.getValueAt(i, 2)),String.valueOf(model2.getValueAt(i, 2)),
						 	"",""));
			 }
        ...
        /* Set a custom renderer on the "Passed" column */         
           ...
           showPrintDialogBox.addActionListener(new ActionListener() {             
            public void actionPerformed(ActionEvent ae) {                 
                 ...
                 JOptionPane.showMessageDialog(FenetreImpressionListeParGroupe.this,"If the Print Dialog is not shown,"+ " the default printer is used.", 
           ...
           interactiveBox.addActionListener(new ActionListener() {             
              public void actionPerformed(ActionEvent ae) {                 
                    if (!interactiveBox.isSelected()) {                     
                        JOptionPane.showMessageDialog(FenetreImpressionListeParGroupe.this,"If non-interactive, the GUI is fully blocked"
          ...
          public Component getTableCellRendererComponent(JTable table,Object value,boolean isSelected,boolean hasFocus,int row,int column) {
            ...
            return this;         
              ...
              public class Multirender implements TableCellRenderer{
                 ...
                 JLabel titre=new JLabel("<html> <div id='bloc_page'> LISTE&nbsp;DES&nbsp;ETUDIANTS&nbsp;DANS&nbsp;LE&nbsp;GROUPE&nbsp;"+ue+"&nbsp;</div></html>");
              ...
              public Component getTableCellRendererComponent(JTable table, Object value,
            	...
            	titre.setFont(font);
            	  if(row==0) {
                	  ...
                	  JLabel salle=new JLabel("<html> <div id='bloc_page'>GROUPE&nbsp;:&nbsp;"+ue+"&nbsp;,&nbsp;N°&nbsp;"
                	  		+ " "+x+"&nbsp;à&nbsp;"+y+"</div></html>");
            	  ...
            	  JLabel ec1= new JLabel("<html> <div id='bloc_page'>"+feed1.ec1+"</div></html>");
