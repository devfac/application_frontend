...
public class BourseMathsP {
	...
	public static void ajouter() {
		...
		for(int i=0;i<5;i++) {
			...
			titre[i]=new JLabel("LISTE DES ETUDIANTS BOURSSIER PASSANT EN L"+(i+1)+" ");
			titre1[i]=new JLabel("LISTE DES ETUDIANTS BOURSSIER PASSANT EN M"+(i-2)+" ");
			...
			tableParc[i].setFillsViewportHeight(true);
				...
				panelTable[i]= new PanelBourse(semestre[i]+" M.I.S.S ",table[i],actmiss[i],modeltable[i]);
