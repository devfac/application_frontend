...
public class FaceCarte implements TableCellRenderer{ 
	...
	public FaceCarte(String mention,String clas) {
		...
		boolean isSelected, boolean hasFocus, int row, int column) {  
			...
			paneTete.setBackground(new Color(255,255,255,50));
			paneCentre.setBackground(new Color(255,255,255,50));
			paneBas.setBackground(new Color(255,255,255,50));
			paneParc.setBackground(new Color(255,255,255,50));
			...
			photo.setBorder(pic);
			photo.setIcon(ImageBonneQualite.image(feed.pic,80));
