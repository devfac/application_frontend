...
public class LoginPrincipale{
	...
	public static JButton mentPA = new  JButton("Ouvrir la fen�tre");
	public static JButton mentPC= new  JButton("Ouvrir la fen�tre");
	...
	public static   JMenuItem l1F = new  JMenuItem("Premi�re ann�e");
	public static   JMenuItem l2F = new  JMenuItem("Deuxi�me ann�e");
	public static   JMenuItem l3F = new  JMenuItem("Troisi�me ann�e");
	...
	public static   JMenuItem l1D = new  JMenuItem("Premi�re ann�e");
	public static   JMenuItem l2D = new  JMenuItem("Deuxi�me ann�e");
	public static   JMenuItem l3D = new  JMenuItem("Troisi�me ann�e");
	...
	public static void ajouter() {
		...
		//.setFont(poilice2);
		gestDroit.setFont(poilice2);
		enseignant.setFont(poilice2);
		
		gestCartf.setForeground(Color.black);
		gestCartPart.setForeground(Color.black);
		...
		gestImport.setForeground(Color.black);
		...
		gestEtDroit.setForeground(Color.black);
		gestDroit.setForeground(Color.black);
		...
		gestImport.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
		...
		gestCartPart.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
		...
		gestEtDroit.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
